...
set REPO_URL=https://github.com/janvarev/kobold_api_multilang_proxy
set umamba_exists=F
...
if exist kobold_api_multilang_proxy\ (
  cd kobold_api_multilang_proxy
  git pull
) else (
  git clone https://github.com/janvarev/kobold_api_multilang_proxy
  cd kobold_api_multilang_proxy || goto end
)
